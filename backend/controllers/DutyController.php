...
class DutyController extends \yii\web\Controller
{
     ...
     * - item group=运营管理 category=值班 description=创建 sort=801 method=get,post
     * - item group=运营管理 category=值班 description=修改 sort=802 method=get,post
     * - item group=运营管理 category=值班 description=删除 sort=803 method=get,post
            ...
            'index' => [
                ...
                'data' => function(){
                        ...
                        $dataProvider = new ActiveDataProvider([
                            'query' => Duty::find()->orderBy('duty_time desc'),
                        ]);
