...
namespace backend\modules\zhuanlan\models\search;

use backend\behaviors\TimeSearchBehavior;
use backend\components\search\SearchEvent;
use backend\modules\zhuanlan\models\Article;
use backend\modules\zhuanlan\models\Category;
use Yii;
use yii\base\Model;
...
class ArticleSearch extends Article
{
    ...
    {
        return [
            [['title', 'author_name', 'cid', 'content', 'sub_title', 'summary'], 'string'],
     ...
     */
    public function search($params, $userid = 1)
    {
        $query = Article::find()->select([])->with('category')->joinWith("articleContent");
