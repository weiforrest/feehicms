...
namespace backend\modules\zhuanlan\controllers;

use Yii;
use backend\modules\zhuanlan\models\Article;
use backend\modules\zhuanlan\models\search\ArticleSearch;
        ...
        return [
            'index' => [
                ...
                'data' => function(){
                    ...
                    $dataProvider = $searchModel->search( Yii::$app->getRequest()->getQueryParams() , $currentUserId);
                    return [
